 ...
 * @author akm
 */
public class MemberIssueBook extends javax.swing.JFrame {

    /**
     * Creates new form MemberIssueBook
     */
    public MemberIssueBook() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btn_issue.setBackground(new java.awt.Color(209, 101, 24));
        btn_issue.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btn_issue.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/issue.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(return_date, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(b_id, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(20, 20, 20)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(issueDate, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_issue, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_close, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26))
        );

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 120, 410, 330));
    ...
    private void btn_issueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_issueActionPerformed
        SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy");// format date
        String bookID = b_id.getText();
        String StudentID = s_id.getText();
        String issuedDate = df.format(issueDate.getDate());
        String returnDate = df.format(return_date.getDate());
        ...
        try {
            ...
            if (RS.next()) {
                ResultSet RSG = st.executeQuery("select * from issue where bookID='" + bookID + "' and returnBook='No'");
                if (RSG.next()) {
                    JOptionPane.showMessageDialog(this, "Book is not available");
                } else {
                    st.executeUpdate("insert into issue values('" + bookID + "','" + StudentID + "','" + issuedDate + "','" + returnDate + "','" + returnBook + "')");
                    JOptionPane.showMessageDialog(null, "You successfully issued the book");
                    setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MemberIssueBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
