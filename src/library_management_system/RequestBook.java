...
public class RequestBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 100, 410, 380));
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        // TODO add your handling code here:
        //String request_bookID = req_bookID.getText();
        ...
        try {
            ...
            if (RS.next()) {
//                st.executeUpdate("insert into request values('" + request_bookID + "','" + StudentID + "','" 
//                        + book_name + "','" + book_publisher + "','" + book_publish_year + "','" + Edition + "')");
//                JOptionPane.showMessageDialog(null, "You successfully issued the book");
//                setVisible(false);
//                new RequestBook().setVisible(true);
                if (StudentID.trim().length() == 0 || StudentID.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(rootPane, "Student ID cannot be empty");
                } else if (book_name.trim().length() == 0 || book_name.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(rootPane, "Book Name cannot be empty");
                } else if (book_publisher.trim().length() == 0 || book_publisher.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(rootPane, "Publisher Name cannot be empty");
                } else if (book_publish_year.trim().length() == 0 || book_publish_year.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(rootPane, "{ublish Year cannot be empty");
                }else if (Edition.trim().length() == 0 || Edition.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(rootPane, "Edition cannot be empty");
                } else {
                    pst = con.prepareStatement("insert into request(StudentID,book_name,book_publisher,book_publish_year,Edition)values(?,?,?,?,?)");
                    ...
                    if (k == 1) {
                        JOptionPane.showMessageDialog(null, "You Successfully Request Book!");
                        student_id.setText("");
                        b_name.setText("");
                        pub.setText("");
                        b_publish_year.setText("");
                        ...
                        JOptionPane.showMessageDialog(null, "Cannot Request Book");
                    }
                    setVisible(false);
                    new RequestBook().setVisible(true);
                }
