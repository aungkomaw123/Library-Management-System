...
import java.sql.*;// import mysql
import project.ConnectionProvider;//import database connection
...
public class UserLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        member_email.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        member_password.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(member_email, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                    .addComponent(member_password))
                .addGap(58, 58, 58))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 90, 430, 310));
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        String Student_email = member_email.getText();
        String Student_password = member_password.getText();
//        try{
//         Connection con = ConnectionProvider.getCon();
//         Statement st = con.createStatement();
//         ResultSet RS = st.executeQuery("select * from student where Student_email='"+student_email+"' and Student_password='"+student_password+"'");
//       //  st.executeUpdate("insert into book values('"+bookID+"','"+book_name+"','"+publisher+"','"+price+"','"+publish_year+"','"+edition+"')");
//         if(RS.isBeforeFirst()){
//             while(RS.next()){
//                 if(RS.getString(2).equalsIgnoreCase(student_email)&&RS.getString(3).equalsIgnoreCase(student_password)){
...
//     }
//     catch(Exception e){
//         JOptionPane.showMessageDialog(null,"Database Errors");
//       
